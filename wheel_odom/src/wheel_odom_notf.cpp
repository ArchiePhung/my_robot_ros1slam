...
const double TICKS_PER_REVOLUTION = 858; // 620 For reference purposes.
const double WHEEL_RADIUS = 0.0325; // Wheel radius in meters
const double WHEEL_BASE = 0.27; // Center of left tire to center of right tire
const double TICKS_PER_METER = 4201.705; // Original was 2800
